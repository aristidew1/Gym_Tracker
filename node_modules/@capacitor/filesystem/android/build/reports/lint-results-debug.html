...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      ...
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Fri Jul 17 01:16:41 CEST 2026 by AGP (8.13.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#UseKtx"><i class="material-icons warning-icon">warning</i>Use KTX extension function (1)</a>
    </nav>
  </div>
...
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:20</span>: <span class="message">A newer version of com.android.tools.build:gradle than 8.13.0 is available: 9.3.0. (There is also a newer version of 8.13.&#55349;&#56421; available, if upgrading to 9.3.0 is difficult: 8.13.2)</span><br /><pre class="errorlines">
<span class="lineno"> 17 </span>        }
<span class="lineno"> 18 </span>    }
<span class="lineno"> 19 </span>    dependencies {
<span class="caretline"><span class="lineno"> 20 </span>        classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:8.13.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 21 </span>        classpath <span class="string">"org.jetbrains.kotlin:kotlin-gradle-plugin:$kotlin_version"</span>
<span class="lineno"> 22 </span>        <span class="keyword">if</span> (System.getenv(<span class="string">"CAP_PLUGIN_PUBLISH"</span>) == <span class="string">"true"</span>) {
<span class="lineno"> 23 </span>            classpath <span class="string">'io.github.gradle-nexus:publish-plugin:1.3.0'</span></pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/kotlin/com/capacitorjs/plugins/filesystem/LegacyFilesystemImplementation.kt">../../src/main/kotlin/com/capacitorjs/plugins/filesystem/LegacyFilesystemImplementation.kt</a>:64</span>: <span class="message">Use the KTX extension function <code>String.toUri</code> instead?</span><br /><pre class="errorlines">
<span class="lineno">  61 </span>
<span class="lineno">  62 </span>    private <span class="keyword">fun</span> getFileObject(path: String, directory: String?): File? {
<span class="lineno">  63 </span>        <span class="keyword">if</span> (directory == <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno">  64 </span>            <span class="keyword">val</span> u = <span class="warning">Uri.parse(path)</span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  65 </span>            <span class="keyword">if</span> (u.scheme == <span class="keyword">null</span> || u.scheme == <span class="string">"file"</span>) {
<span class="lineno">  66 </span>                <span class="keyword">return</span> File(u.path)
