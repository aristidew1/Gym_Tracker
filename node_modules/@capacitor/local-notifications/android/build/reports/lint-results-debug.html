...
<div class="mdl-layout mdl-js-layout mdl-layout--fixed-header">
  <header class="mdl-layout__header">
    <div class="mdl-layout__header-row">
      <span class="mdl-layout-title">Lint Report: 1 error and 9 warnings</span>
      <div class="mdl-layout-spacer"></div>
      <nav class="mdl-navigation mdl-layout--large-screen-only">Check performed at Fri Jul 17 01:16:35 CEST 2026 by AGP (8.13.0)</nav>
    </div>
  </header>
  <div class="mdl-layout__drawer">
    ...
    <nav class="mdl-navigation">
      ...
      <a class="mdl-navigation__link" href="#MissingPermission"><i class="material-icons error-icon">error</i>Missing Permissions (4)</a>
      <a class="mdl-navigation__link" href="#SimpleDateFormat"><i class="material-icons warning-icon">warning</i>Implied locale in date format (3)</a>
      <a class="mdl-navigation__link" href="#ManifestOrder"><i class="material-icons warning-icon">warning</i>Incorrect order of elements in manifest (1)</a>
      ...
      <a class="mdl-navigation__link" href="#UnsafeProtectedBroadcastReceiver"><i class="material-icons warning-icon">warning</i>Unsafe Protected <code>BroadcastReceiver</code> (1)</a>
    </nav>
  </div>
...
<tr>
<td class="countColumn">4</td><td class="issueColumn"><i class="material-icons error-icon">error</i>
...
<a href="#ManifestOrder">ManifestOrder</a>: Incorrect order of elements in manifest</td></tr>
<tr>
<td class="countColumn">1</td><td class="issueColumn"><i class="material-icons warning-icon">warning</i>
...
<tr><td></td><td class="categoryColumn"><a href="#ExtraIssues">Included Additional Checks (27)</a>
</td></tr>
...
<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java</a>:242</span>: <span class="message">Call requires permission which may be rejected by user: code should explicitly check to see if permission is available (with <code>checkPermission</code>) or explicitly handle a potential <code>SecurityException</code></span><br /><pre class="errorlines">
<span class="lineno"> 239 </span>                JSObject notificationJson = <span class="keyword">new</span> JSObject(localNotification.getSource());
<span class="lineno"> 240 </span>                LocalNotificationsPlugin.fireReceived(notificationJson);
<span class="lineno"> 241 </span>            } <span class="keyword">catch</span> (JSONException e) {}
<span class="caretline"><span class="lineno"> 242 </span>            <span class="error">notificationManager.notify(localNotification.getId(), buildNotification)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 243 </span>        }
<span class="lineno"> 244 </span>    }
</pre>

<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java</a>:392</span>: <span class="message">Setting Exact alarms with <code>setExactAndAllowWhileIdle</code> requires the <code>SCHEDULE_EXACT_ALARM</code> permission or power exemption from user; it is intended for applications where the user knowingly schedules actions to happen at a precise time such as alarms, clocks, calendars, etc. Check out the javadoc on this permission to make sure your use case is valid.</span><br /><pre class="errorlines">
<span class="lineno"> 389 </span>      }
<span class="lineno"> 390 </span>  } <span class="keyword">else</span> {
<span class="lineno"> 391 </span>      <span class="keyword">if</span> (schedule.allowWhileIdle()) {
<span class="caretline"><span class="lineno"> 392 </span>          <span class="warning">alarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, trigger, pendingIntent)</span>;</span>
<span class="lineno"> 393 </span>      } <span class="keyword">else</span> {
<span class="lineno"> 394 </span>          alarmManager.setExact(AlarmManager.RTC, trigger, pendingIntent);
<span class="lineno"> 395 </span>      }
</pre>

<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java</a>:394</span>: <span class="message">Setting Exact alarms with <code>setExact</code> requires the <code>SCHEDULE_EXACT_ALARM</code> permission or power exemption from user; it is intended for applications where the user knowingly schedules actions to happen at a precise time such as alarms, clocks, calendars, etc. Check out the javadoc on this permission to make sure your use case is valid.</span><br /><pre class="errorlines">
<span class="lineno"> 391 </span>          <span class="keyword">if</span> (schedule.allowWhileIdle()) {
<span class="lineno"> 392 </span>              alarmManager.setExactAndAllowWhileIdle(AlarmManager.RTC_WAKEUP, trigger, pendingIntent);
<span class="lineno"> 393 </span>          } <span class="keyword">else</span> {
<span class="caretline"><span class="lineno"> 394 </span>              <span class="warning">alarmManager.setExact(AlarmManager.RTC, trigger, pendingIntent)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 395 </span>          }
<span class="lineno"> 396 </span>      }
<span class="lineno"> 397 </span>  }
</pre>

<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/TimedNotificationPublisher.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/TimedNotificationPublisher.java</a>:81</span>: <span class="message">Setting Exact alarms with <code>setExact</code> requires the <code>SCHEDULE_EXACT_ALARM</code> permission or power exemption from user; it is intended for applications where the user knowingly schedules actions to happen at a precise time such as alarms, clocks, calendars, etc. Check out the javadoc on this permission to make sure your use case is valid.</span><br /><pre class="errorlines">
<span class="lineno"> 78 </span>      );
<span class="lineno"> 79 </span>      alarmManager.set(AlarmManager.RTC, trigger, pendingIntent);
<span class="lineno"> 80 </span>  } <span class="keyword">else</span> {
<span class="caretline"><span class="lineno"> 81 </span>      <span class="warning">alarmManager.setExact(AlarmManager.RTC, trigger, pendingIntent)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 82 </span>  }
<span class="lineno"> 83 </span>  SimpleDateFormat sdf = <span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy/MM/dd HH:mm:ss"</span>);
<span class="lineno"> 84 </span>  Logger.debug(Logger.tags(<span class="string">"LN"</span>), <span class="string">"notification "</span> + id + <span class="string">" will next fire at "</span> + sdf.format(<span class="keyword">new</span> Date(trigger)));
</pre>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationManager.java</a>:369</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 366 </span>          notificationIntent.putExtra(TimedNotificationPublisher.CRON_KEY, on.toMatchString());
<span class="lineno"> 367 </span>          pendingIntent = PendingIntent.getBroadcast(context, request.getId(), notificationIntent, flags);
<span class="lineno"> 368 </span>          setExactIfPossible(alarmManager, schedule, trigger, pendingIntent);
<span class="caretline"><span class="lineno"> 369 </span>          SimpleDateFormat sdf = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy/MM/dd HH:mm:ss"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 370 </span>          Logger.debug(Logger.tags(<span class="string">"LN"</span>), <span class="string">"notification "</span> + request.getId() + <span class="string">" will next fire at "</span> + sdf.format(<span class="keyword">new</span> Date(trigger)));
<span class="lineno"> 371 </span>      }
<span class="lineno"> 372 </span>  }
</pre>

<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationSchedule.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationSchedule.java</a>:55</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno">  52 </span>        <span class="keyword">this</span>.repeats = schedule.getBool(<span class="string">"repeats"</span>);
<span class="lineno">  53 </span>        String dateString = schedule.getString(<span class="string">"at"</span>);
<span class="lineno">  54 </span>        <span class="keyword">if</span> (dateString != <span class="keyword">null</span>) {
<span class="caretline"><span class="lineno">  55 </span>            SimpleDateFormat sdf = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(JS_DATE_FORMAT)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno">  56 </span>            sdf.setTimeZone(TimeZone.getTimeZone(<span class="string">"UTC"</span>));
<span class="lineno">  57 </span>            <span class="keyword">this</span>.at = sdf.parse(dateString);
<span class="lineno">  58 </span>        }
</pre>

<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/TimedNotificationPublisher.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/TimedNotificationPublisher.java</a>:83</span>: <span class="message">To get local formatting use <code>getDateInstance()</code>, <code>getDateTimeInstance()</code>, or <code>getTimeInstance()</code>, or use <code>new SimpleDateFormat(String template, Locale locale)</code> with for example <code>Locale.US</code> for ASCII dates.</span><br /><pre class="errorlines">
<span class="lineno"> 80 </span>      } <span class="keyword">else</span> {
<span class="lineno"> 81 </span>          alarmManager.setExact(AlarmManager.RTC, trigger, pendingIntent);
<span class="lineno"> 82 </span>      }
<span class="caretline"><span class="lineno"> 83 </span>      SimpleDateFormat sdf = <span class="warning"><span class="keyword">new</span> SimpleDateFormat(<span class="string">"yyyy/MM/dd HH:mm:ss"</span>)</span>;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 84 </span>      Logger.debug(Logger.tags(<span class="string">"LN"</span>), <span class="string">"notification "</span> + id + <span class="string">" will next fire at "</span> + sdf.format(<span class="keyword">new</span> Date(trigger)));
<span class="lineno"> 85 </span>      <span class="keyword">return</span> <span class="keyword">true</span>;
...
Dismiss</button>            </div>
          ...
          </section><a name="ManifestOrder"></a>
<section class="section--center mdl-grid mdl-grid--no-spacing mdl-shadow--2dp" id="ManifestOrderCard" style="display: block;">
            <div class="mdl-card mdl-cell mdl-cell--12-col">
  <div class="mdl-card__title">
    <h2 class="mdl-card__title-text">Incorrect order of elements in manifest</h2>
  </div>
              <div class="mdl-card__supporting-text">
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/AndroidManifest.xml">../../src/main/AndroidManifest.xml</a>:17</span>: <span class="message"><code>&lt;uses-permission></code> tag appears after <code>&lt;application></code> tag</span><br /><pre class="errorlines">
<span class="lineno"> 14 </span>            <span class="tag">&lt;/intent-filter></span>
<span class="lineno"> 15 </span>        <span class="tag">&lt;/receiver></span>
<span class="lineno"> 16 </span>    <span class="tag">&lt;/application></span>
<span class="caretline"><span class="lineno"> 17 </span>    <span class="tag">&lt;</span><span class="warning"><span class="tag">uses-permission</span></span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"android.permission.RECEIVE_BOOT_COMPLETED"</span>/>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 18 </span>    <span class="tag">&lt;uses-permission</span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"android.permission.WAKE_LOCK"</span>/>
<span class="lineno"> 19 </span>    <span class="tag">&lt;uses-permission</span><span class="attribute"> </span><span class="prefix">android:</span><span class="attribute">name</span>=<span class="value">"android.permission.POST_NOTIFICATIONS"</span>/>
<span class="lineno"> 20 </span><span class="tag">&lt;/manifest></span></pre>

</div>
<div class="metadata"><div class="explanation" id="explanationManifestOrder" style="display: none;">
...
<div class="chips">
<span class="mdl-chip">
    <span class="mdl-chip__text">ManifestOrder</span>
</span>
<span class="mdl-chip">
    <span class="mdl-chip__text">Correctness</span>
</span>
...
<span class="mdl-chip">
    <span class="mdl-chip__text">Priority 5/10</span>
              ...
              <div class="mdl-card__actions mdl-card--border">
<button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="explanationManifestOrderLink" onclick="reveal('explanationManifestOrder');">
Explain</button><button class="mdl-button mdl-js-button mdl-js-ripple-effect" id="ManifestOrderCardLink" onclick="hideid('ManifestOrderCard');">
Dismiss</button>            </div>
            </div>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../build.gradle">../../build.gradle</a>:18</span>: <span class="message">A newer version of com.android.tools.build:gradle than 8.13.0 is available: 9.3.0. (There is also a newer version of 8.13.&#55349;&#56421; available, if upgrading to 9.3.0 is difficult: 8.13.2)</span><br /><pre class="errorlines">
<span class="lineno"> 15 </span>        }
<span class="lineno"> 16 </span>    }
<span class="lineno"> 17 </span>    dependencies {
<span class="caretline"><span class="lineno"> 18 </span>        classpath <span class="warning"><span class="string">'com.android.tools.build:gradle:8.13.0'</span></span>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 19 </span>        <span class="keyword">if</span> (System.getenv(<span class="string">"CAP_PLUGIN_PUBLISH"</span>) == <span class="string">"true"</span>) {
<span class="lineno"> 20 </span>            classpath <span class="string">'io.github.gradle-nexus:publish-plugin:1.3.0'</span>
...
<div class="issue">
<div class="warningslist">
<span class="location"><a href="../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationRestoreReceiver.java">../../src/main/java/com/capacitorjs/plugins/localnotifications/LocalNotificationRestoreReceiver.java</a>:15</span>: <span class="message">This broadcast receiver declares an intent-filter for a protected broadcast action string, which can only be sent by the system, not third-party applications. However, the receiver's <code>onReceive</code> method does not appear to call <code>getAction</code> to ensure that the received Intent's action string matches the expected value, potentially making it possible for another actor to send a spoofed intent with no action string or a different action string and cause undesired behavior.</span><br /><pre class="errorlines">
<span class="lineno"> 12 </span><span class="keyword">public</span> <span class="keyword">class</span> LocalNotificationRestoreReceiver <span class="keyword">extends</span> BroadcastReceiver {
<span class="lineno"> 13 </span>
<span class="lineno"> 14 </span>    <span class="annotation">@Override</span>
<span class="caretline"><span class="lineno"> 15 </span>    <span class="keyword">public</span> <span class="keyword">void</span> <span class="warning">onReceive</span>(Context context, Intent intent) {&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
<span class="lineno"> 16 </span>        UserManager um = context.getSystemService(UserManager.<span class="keyword">class</span>);
<span class="lineno"> 17 </span>        <span class="keyword">if</span> (um == <span class="keyword">null</span> || !um.isUserUnlocked()) <span class="keyword">return</span>;
</pre>
