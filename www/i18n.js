...
const FR = {
  ...
  settings: 'Paramètres', language: 'Langue', french: 'Français', english: 'Anglais', appearance: 'Apparence', theme: 'Thème', themeDark: 'Sombre', themeLight: 'Clair', privacyPolicy: 'Politique de confidentialité', home: 'Accueil', calendar: 'Calendrier', stats: 'Stats', programs: 'Programmes',
  ...
  onboardingTitle: 'Bienvenue dans Muscu Tracker', onboardingDescription: 'Choisis comment démarrer. Tu pourras tout modifier ensuite.', onboardingCreate: 'Créer mon programme', onboardingCreateDesc: 'Pars d’un programme vierge et configure chaque séance.', onboardingExample: 'Utiliser le programme exemple', onboardingExampleDesc: 'Un cycle avancé tractions & deadlift à adapter.', onboardingImport: 'Importer un programme', onboardingImportDesc: 'Ajoute un programme depuis une sauvegarde JSON.', tourSkip: 'Passer le guide', tourNext: 'Suivant', tourDone: 'C’est parti', tourStep: 'Étape {current} sur {total}', tourProgramTitle: 'Ton programme', tourProgramDescription: 'Choisis une séance depuis l’accueil. Tu peux modifier ton programme à tout moment dans l’onglet Programmes.', tourWorkoutTitle: 'Pendant la séance', tourWorkoutDescription: 'Saisis ta charge et tes répétitions, puis coche la série terminée. Le repos se lance automatiquement.', tourRestTitle: 'Repos et navigation', tourRestDescription: 'Le repos s’ouvre en plein écran. Réduis-le pour parcourir l’app : ton bandeau « Séance en cours » permet de reprendre instantanément.', tourProgressTitle: 'Suis ta progression', tourProgressDescription: 'Retrouve tes séances dans le calendrier et l’évolution de chaque exercice dans les statistiques.',
  finish: 'Terminer', back: 'Retour', previousMonth: 'Mois précédent', nextMonth: 'Mois suivant', consecutiveWorkouts: 'séances consécutives', consecutiveWeeks: 'semaines réussies consécutives', statistics: 'Statistiques', performanceProgress: 'Progression de tes performances', editWorkout: 'Éditer la séance', editWorkoutDesc: 'Ajoute ou remplace des exercices pour cette séance uniquement.', discardWorkout: 'Abandonner la séance', discardWorkoutConfirm: 'Le repos et la sauvegarde de cette séance seront supprimés. Continuer ?', bonusBlock: 'Bloc bonus {count}', selectBlock: 'Bloc à modifier', newBonusBlock: '＋ Nouveau bloc bonus', blockName: 'Nom du bloc', blockType: 'Type de bloc', superset: 'Superset', addExerciseToWorkout: 'Ajouter un exercice', bonusOnly: 'Les changements ne modifient pas ton programme.', replace: 'Remplacer', replaceExercise: "Changer d'exercice", recordedExercises: 'Exercices enregistrés', editingRecordedWorkout: "Modification d'une séance enregistrée", editRecordedWorkout: 'Modifier cette séance', recordedWorkoutSaved: 'Séance modifiée ✓',
...
const EN = {
  ...
  settings: 'Settings', language: 'Language', french: 'French', english: 'English', appearance: 'Appearance', theme: 'Theme', themeDark: 'Dark', themeLight: 'Light', privacyPolicy: 'Privacy policy',
  ...
  onboardingTitle: 'Welcome to Muscu Tracker', onboardingDescription: 'Choose how you want to start. Everything remains editable afterwards.', onboardingCreate: 'Create my program', onboardingCreateDesc: 'Start from a blank program and configure every workout.', onboardingExample: 'Use the example program', onboardingExampleDesc: 'An advanced pull-up and deadlift cycle to adapt.', onboardingImport: 'Import a program', onboardingImportDesc: 'Add a program from a JSON backup.', tourSkip: 'Skip guide', tourNext: 'Next', tourDone: 'Let’s go', tourStep: 'Step {current} of {total}', tourProgramTitle: 'Your program', tourProgramDescription: 'Choose a workout from Home. You can edit your program at any time in the Programs tab.', tourWorkoutTitle: 'During your workout', tourWorkoutDescription: 'Enter your load and repetitions, then tick the completed set. Rest starts automatically.', tourRestTitle: 'Rest and browsing', tourRestDescription: 'Rest opens fullscreen. Reduce it to browse the app: the “Workout in progress” banner instantly resumes your session.', tourProgressTitle: 'Track your progress', tourProgressDescription: 'Find your workouts in the calendar and each exercise’s progress in statistics.',
  rollingCycle: 'Rolling cycle — every other day', nextSuggested: 'Next suggested workout:',
  finish: 'Finish', back: 'Back', previousMonth: 'Previous month', nextMonth: 'Next month', editWorkout: 'Edit workout', editWorkoutDesc: 'Add or replace exercises for this workout only.', discardWorkout: 'Discard workout', discardWorkoutConfirm: 'The rest timer and saved in-progress workout will be deleted. Continue?', bonusBlock: 'Bonus block {count}', selectBlock: 'Block to edit', newBonusBlock: '＋ New bonus block', blockName: 'Block name', blockType: 'Block type', superset: 'Superset', addExerciseToWorkout: 'Add exercise', bonusOnly: 'These changes do not modify your program.', replace: 'Replace', replaceExercise: 'Change exercise', recordedExercises: 'Recorded exercises', editingRecordedWorkout: 'Editing a recorded workout', editRecordedWorkout: 'Edit this workout', recordedWorkoutSaved: 'Workout updated ✓',
...
const TEXT_EN = {
  'Programme exemple — tractions & deadlift': 'Example program — pull-ups & deadlift',
  'Exemple avancé A/B/C/D, un jour sur deux, à adapter à ton matériel et à tes objectifs.': 'Advanced A/B/C/D example, every other day, to adapt to your equipment and goals.',
