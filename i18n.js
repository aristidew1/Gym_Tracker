...
const FR = {
  ...
  settings: 'Paramètres', language: 'Langue', french: 'Français', english: 'Anglais', home: 'Accueil', calendar: 'Calendrier', stats: 'Stats', programs: 'Programmes',
  ...
  finish: 'Terminer', back: 'Retour', previousMonth: 'Mois précédent', nextMonth: 'Mois suivant', consecutiveWorkouts: 'séances consécutives', statistics: 'Statistiques', performanceProgress: 'Progression de tes performances', editWorkout: 'Éditer la séance', editWorkoutDesc: 'Ajoute des exercices bonus pour cette séance uniquement.', bonusBlock: 'Bloc bonus {count}', selectBlock: 'Bloc à modifier', newBonusBlock: '＋ Nouveau bloc bonus', blockName: 'Nom du bloc', blockType: 'Type de bloc', superset: 'Superset', addExerciseToWorkout: 'Ajouter un exercice', bonusOnly: 'Les changements ne modifient pas ton programme.',
  ...
  data: 'Données', backupFull: 'Sauvegarde complète', programsOnly: 'Programmes uniquement', calendarLegend: 'Couleur de chaque séance', exportData: 'Exporter les données', exportDataDesc: 'Télécharge tes séances et tes programmes en fichier JSON', export: 'Exporter', importData: 'Importer des données', importDataDesc: 'Charge une sauvegarde JSON de tes séances et programmes', import: 'Importer', exportPrograms: 'Exporter les programmes', exportProgramsDesc: 'Télécharge uniquement tes programmes, sans les séances', importPrograms: 'Importer des programmes', importProgramsDesc: 'Ajoute des programmes sans modifier tes séances',
  mondayShort: 'Lun', tuesdayShort: 'Mar', wednesdayShort: 'Mer', thursdayShort: 'Jeu', fridayShort: 'Ven', saturdayShort: 'Sam', sundayShort: 'Dim',
  leaveWorkout: 'Quitter la séance ?', leaveWorkoutDesc: 'Ta séance en cours ne sera pas sauvegardée.', today: "Aujourd'hui", yesterday: 'Hier', daysAgo: 'Il y a {count}j', next: 'Suivante', method: 'Méthode', choice: 'Choix',
  ...
  builder: 'Constructeur', everythingEditable: 'Tout est modifiable manuellement', undo: 'Annuler', redo: 'Rétablir', save: 'Enregistrer', programName: 'Nom du programme', programDescription: 'Description', goal: 'Objectif', level: 'Niveau', duration: 'Durée indicative', minutes: 'minutes',
  ...
  deleteRecordedWorkout: 'Supprimer cette séance', deleteRecordedWorkoutConfirm: 'Voulez-vous vraiment supprimer cette séance ?', restTomorrow: '😴 Repos demain', restToday: "😴 Repos aujourd'hui", nextWorkout: 'Prochaine séance : {name}', tomorrowWorkout: 'Demain : {name}', workoutToday: "🏋️ {name} aujourd'hui", unknownExercise: 'Exercice inconnu', copySuffix: '{name} - copie',
};
...
const EN = {
  ...
  settings: 'Settings', language: 'Language', french: 'French', english: 'English',
  ...
  finish: 'Finish', back: 'Back', previousMonth: 'Previous month', nextMonth: 'Next month', editWorkout: 'Edit workout', editWorkoutDesc: 'Add bonus exercises for this workout only.', bonusBlock: 'Bonus block {count}', selectBlock: 'Block to edit', newBonusBlock: '＋ New bonus block', blockName: 'Block name', blockType: 'Block type', superset: 'Superset', addExerciseToWorkout: 'Add exercise', bonusOnly: 'These changes do not modify your program.',
  consecutiveWorkouts: 'consecutive workouts', statistics: 'Statistics', performanceProgress: 'Your performance progress',
  ...
  data: 'Data', backupFull: 'Full backup', programsOnly: 'Programs only', calendarLegend: 'Workout color legend', exportData: 'Export data', exportDataDesc: 'Downloads your workouts and programs as a JSON file', export: 'Export',
  importData: 'Import data', importDataDesc: 'Loads a JSON backup of your workouts and programs', import: 'Import', exportPrograms: 'Export programs', exportProgramsDesc: 'Downloads only your programs, without workouts', importPrograms: 'Import programs', importProgramsDesc: 'Adds programs without changing your workouts',
  mondayShort: 'Mon', tuesdayShort: 'Tue', wednesdayShort: 'Wed', thursdayShort: 'Thu', fridayShort: 'Fri', saturdayShort: 'Sat', sundayShort: 'Sun',
  leaveWorkout: 'Leave workout?', leaveWorkoutDesc: 'Your current workout will not be saved.',
  ...
  builder: 'Builder', everythingEditable: 'Everything can be edited manually', undo: 'Undo', redo: 'Redo', save: 'Save',
  ...
  restTomorrow: '😴 Rest tomorrow', restToday: '😴 Rest today', nextWorkout: 'Next workout: {name}', tomorrowWorkout: 'Tomorrow: {name}', workoutToday: '🏋️ {name} today',
